...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.heading('costs', text='Пробег')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_sum = tk.Label(self, text='Пробег на сегодня')
        ...
        self.combobox = ttk.Combobox(self, values=[u'Пробег'])
...
class DB:
    def __init__(self):
        ...
        self.c.execute(
            '''CREATE TABLE IF NOT EXISTS finance (id integer primary key, description text, costs real, total real)''')
        self.conn.commit()
